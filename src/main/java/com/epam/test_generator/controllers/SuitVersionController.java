...
public class SuitVersionController {
    ...
    public ResponseEntity<List<SuitVersionDTO>> getCaseVersions(@PathVariable("projectId") long projectId,
                                                                @PathVariable("suitId") long suitId) {

        return new ResponseEntity<>(suitService.getSuitVersion(projectId, suitId), HttpStatus.OK);
    }
